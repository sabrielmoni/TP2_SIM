...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.valoresTextEdit = QtWidgets.QTextEdit(self.tabGenerador)
        ...
        self.generarGraficoPushButton = QtWidgets.QPushButton(self.tabGenerador)
        self.generarGraficoPushButton.setGeometry(QtCore.QRect(530, 480, 171, 26))
        ...
        self.pushButton = QtWidgets.QPushButton(self.tabGenerador)
        self.pushButton.setGeometry(QtCore.QRect(620, 440, 81, 26))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.normaLabel.setText(_translate("MainWindow", "Distribución Normal"))
        self.uniformeLabel.setText(_translate("MainWindow", "Distribución Uniforme"))
        self.expLabel.setText(_translate("MainWindow", "Distribución Exponencial"))
        self.poissonLabel.setText(_translate("MainWindow", "Distribución Poisson"))
        self.intervalosLabel.setText(_translate("MainWindow", "Intervalos"))
        self.valoresLabel.setText(_translate("MainWindow", "Cantidad de Valores"))
        ...
        self.desviacionEstlabel.setText(_translate("MainWindow", "Desviación Estandar"))
        ...
        self.generarGraficoPushButton.setText(_translate("MainWindow", "Generar Gráfico"))
        self.generarPushButton.setText(_translate("MainWindow", "Generar"))
        self.pushButton.setText(_translate("MainWindow", "Limpiar"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabGenerador), _translate("MainWindow", "Generador"))
        ...
        self.chiCalculadoLabel.setText(_translate("MainWindow", "Chi Calculado"))
        self.chiTabuladoLabel.setText(_translate("MainWindow", "Chi Tabulado"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabChiCuadrado), _translate("MainWindow", "Prueba Chi Cuadrado"))
        ...
        self.ksCalculadoLabel.setText(_translate("MainWindow", "K-S Calculado"))
        self.ksTabuladoLabel.setText(_translate("MainWindow", "K-S Tabulado"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabKS), _translate("MainWindow", "Prueba K-S"))
